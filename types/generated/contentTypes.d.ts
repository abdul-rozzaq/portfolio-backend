...
export interface ApiExperienceExperience extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    started_at: Schema.Attribute.Date & Schema.Attribute.Required;
...
export interface ApiMetaMeta extends Struct.SingleTypeSchema {
  ...
  attributes: {
    available_for_work: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    ...
    linkedin_link: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    preview_image: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    production_link: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiTechnologyTechnology extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'backend'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
